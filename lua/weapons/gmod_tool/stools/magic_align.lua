...
if SERVER then
    ...
    AddCSLuaFile("magic_align/client/world_bsp_records.lua")
    AddCSLuaFile("magic_align/client/world_bsp_reader.lua")
    AddCSLuaFile("magic_align/client/world_bsp.lua")
    AddCSLuaFile("magic_align/client/world_bsp_cache.lua")
...
include("magic_align/client/world_bsp_cache.lua")
